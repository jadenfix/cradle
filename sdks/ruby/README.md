...
| `client.browser_adapter_launch_plan(request)` | `POST /v1/browser/adapter/launch/plan` | yes | `Hash` (raw JSON) |
| `client.browser_adapter_launch_claim(request)` | `POST /v1/browser/adapter/launch/claim` | yes | `Hash` (raw JSON) |
